...
with open('/Users/Billy/Dropbox/Alt Stable States Paper/Data/DataForFigures/April2019Exp/April2019Exp.csv', 'r') as f:
    data1 = list(reader(f))
with open('/Users/Billy/Dropbox/Alt Stable States Paper/Data/DataForFigures/Pci_PvInitialFracAlt/BistabilityAltData10_8.csv', 'r') as f:
    data2 = list(reader(f))
with open('/Users/Billy/Dropbox/Alt Stable States Paper/Data/DataForFigures/SMediaBisAltSF/BistabilityAltDataSF1027.csv', 'r') as f:
    data3 = list(reader(f))


Pci_initial_frac1 = ['88', '39', '15']
Pci_initial_frac2 = ['0.9', '0.5', '0.1']
Pci_initial_frac3 = ['0.89', '0.12', '0.75', '0.34', '0.51']
...
for DF in ['1','2','3','4','5']:
    ...
    for elt in ['Pci-Pv 1', 'Pci-Pv 2']:
        for l in Pci_initial_frac2:
            for i in data2[1::]:
                if i[0] == elt and i[7] == DF and i[8] == l and i[9] == '7':
                    start = (DF, float(l))
                    end = (DF, i[5])
...
plt.plot(np.linspace(.5,4.15,30), np.linspace(0,0,30), ls = '-', color = 'k', lw = 3, zorder = 10)
plt.plot(np.linspace(2.75,5.5,30), np.linspace(1,1,30), ls = '-', color = 'k', lw = 3, zorder = 10)
plt.xlabel('Log(Dilution Factor)', fontsize=22)
plt.ylabel('Pci Fraction', fontsize=22)

plt.tight_layout()
plt.show()
fig1.savefig("/Users/Billy/Desktop/AveragedPciPvBifurcationDiagram.png", dpi=800)